...
# Change selected text color function
def text_color():
    #Pick a color
...
def print_file():
    pass
    # What about for linux user. You only show for windows user
    showinfo("Print file", "Search on google and complete this ASAP")
...
# Add options menu - submenu 4
options_menu = Menu(my_menu, tearoff=False)
my_menu.add_cascade(label="Mode", menu=options_menu)  
